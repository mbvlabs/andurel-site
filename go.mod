...
require (
	...
	github.com/mbvlabs/andurel/pkg/email v0.3.0
	github.com/mbvlabs/andurel/pkg/hypermedia v0.2.1
	github.com/mbvlabs/andurel/pkg/inertia v0.3.0
	github.com/mbvlabs/andurel/pkg/routing v0.1.1
	github.com/mbvlabs/andurel/pkg/server v0.3.0
	github.com/mbvlabs/andurel/pkg/storage v0.6.0
	github.com/mbvlabs/andurel/pkg/validation v0.1.1
